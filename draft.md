...
All of this progress is not at the cost of the Chinese working class or the environment, as [China is still expected to achieve carbon neutrality by 2060](https://www.hbs.edu/bigs/china-poised-to-meet-carbon-neutrality-goal-before-2060) albeit [after Paris climate agreement](https://climateactiontracker.org/countries/china/net-zero-targets/), while the [US is increasingly moving away from that target](https://climateactiontracker.org/countries/usa/net-zero-targets/).

[Add Section summary table]
### Data center vs. power plant: energy and water consumption
- China's data centers consumed ~200 TWh (terawatt-hours — 1 TWh is roughly the annual electricity use of 100,000 US homes) in 2020 (2.7% of national electricity); projected to reach 400 TWh by 2030 (3.7% of national power)
- China accounted for 25% of global data-center electricity consumption in 2024 (IEA), second only to the US
- Water consumption: estimated ~1.3bn m³ today, could rise to >3bn m³ by 2030
- 46% of data center racks are in the "Dry 10" water-scarce provinces
- PUE (Power Usage Effectiveness — the ratio of total power a data center consumes to the power actually used for computing, where 1.0 means every watt goes to the machines and 2.0 means half is lost to cooling and overhead) target: cut large data centers to 1.25 by 2025 (Germany requires 1.5 by 2027)
- **The "data center vs. power plant" split — Microsoft's Nature paper (2025):**
  - Microsoft researchers published the first public cradle-to-grave life cycle assessment (LCA, an accounting of all environmental impacts across a product's full life from raw materials to disposal) of data center cooling, comparing four cooling technologies (air-cooled, cold-plate, one-phase immersion, two-phase immersion) across GHG (greenhouse gas — heat-trapping emissions like CO2 that drive climate change) emissions and energy demand.
...
- **IEA corroboration:**
  ...
  - CO2 emissions from data center electricity peak at ~320 Mt CO2 (megatonnes of CO2 — a million metric tons, roughly the annual output of 60–80 typical 1,000 MW coal plants) by 2030, then enter a shallow decline — because the grid is decarbonizing faster than data center demand is growing.
...
- Guangdong province five-year marine economy plan (2021): encourage "high energy consuming data centers" to relocate underwater in Guangzhou, Shenzhen, Zhuhai
...
- **US energy mix for data centers (IEA):**
  ...
  - 2030–2035: SMRs (Small Modular Reactors, i.e. small nuclear power plants) enter the mix (tech companies have plans to finance >20 GW of SMRs). By 2035, low-emissions sources account for >55% of US data center electricity.
...
- China's first dedicated regulation for AI companion services took effect July 15, 2026
- Article 14: absolutely prohibits providing "virtual relatives, virtual lovers, and other virtual intimate relationships" to all minors (under 18)
...
The driver is price.  Open-weight Chinese models run **60% to 90% cheaper** than the leading Anthropic and OpenAI models ([CNBC](https://www.cnbc.com/2026/07/07/chinese-ai-models-costs-us-openai-anthropic.html)); DeepSeek V4-Flash lists at $0.14 per million input tokens against $5.00 for GPT-5.5 ([Reuters, August 3, 2026](https://www.reuters.com/business/retail-consumer/deepseeks-new-ai-model-is-by-far-cheapest-well-known-models-run-research-firm-2026-08-03/)).  And this is no longer a developer sandbox story — it has moved into corporate expense reports.  [Lindy, a San Francisco AI startup, moved 100% of its traffic from Claude to DeepSeek in June 2026](https://restofworld.org/2026/when-americans-choose-chinese-ai/), saving millions, and DeepSeek became the #1 trending software vendor on the Ramp corporate-card index ([Ramp, June 2026](https://www.ramp.com/data/top-saas-vendors-on-ramp-june-2026)).  Even Airbnb and Anysphere (Cursor) are under congressional investigation after disclosing they built AI infrastructure on Chinese open models like Qwen and Kimi ([Rest of World, June 17, 2026](https://restofworld.org/2026/when-americans-choose-chinese-ai/)).
...
Conversely, China's WAICO seeks to provide meaningful social, technical, and physical infrastructure for AI development in the global south.  Many have [framed it as a beginning to a new cold war](https://stanfordtechreview.com/articles/ai-cold-war-pax-silica-vs-waico), despite the metaphorical shoe not quite fitting.  While neither are actually supported by the UN, I do find it notable that [the UN General Secretary did visit China for the announcement of WAICO](https://thediplomat.com/2026/09/pax-silica-vs-waico-will-central-asia-have-to-pick-a-side/).  Also, in contrast to the US, WAICO membership does not preclude any members from joining Pax Silica, which might eventually lead Kazakhstan to a loggerheads with Washington later.  
...
| **Key provisions** | Charter, Council, and Secretariat; a stated aim of "beneficial, safe and fair" AI; open-source emphasis; no binding rules on companies | Nine prohibited practices; high-risk conformity assessments; GPAI documentation, copyright, and training-data-summary duties; transparency/labeling; systemic-risk testing | Deregulation: EO 14179 (revokes Biden's EO 14110), EO 14365 (state preemption); security: EO 14409 (June 2026, frontier-model cyber security — itself forbidding mandatory licensing); plus state ADMT duties (Colorado, effective Jan 1, 2027) and deepfake/impersonation bans |
