...
|---|---|---|---|
| **What it is** | Intergovernmental cooperation organization, founded July 16, 2026, headquartered in Shanghai; 37 member states, open to all sovereigns, no values test at the door | The first comprehensive AI statute in the world — Regulation (EU) 2024/1689, in force since August 1, 2024, applicable in stages through 2028 | No single federal AI law. A patchwork of state statutes, executive orders, and voluntary frameworks that apply only to federal agencies |
| **Scope** | All member states; oriented toward AI capacity building, technology sharing, and development cooperation for the Global South | Any AI system placed on the EU market, tiered by risk: prohibited practices, high-risk systems, GPAI models (incl. systemic-risk), and transparency duties | Varies by state and sector: e.g., Colorado's automated decision-making law, California's ADMT and training-data transparency rules, Texas's prohibited-use law, Illinois's employment-AI rules; federal EOs target only government use and frontier-model security |
...
| **Key provisions** | Charter, Council, and Secretariat; a stated aim of "beneficial, safe and fair" AI; open-source emphasis; no binding rules on companies | Nine prohibited practices; high-risk conformity assessments; GPAI documentation, copyright, and training-data-summary duties; transparency/labeling; systemic-risk testing | Automated decision-making duties (Colorado, effective Jan 1, 2027); deepfake/impersonation bans (state laws); the NIST AI Risk Management Framework (voluntary); EO 14409 (June 2026) on frontier-model cyber security, which explicitly forbids mandatory licensing |
...
- **Refs:**
  ...
  - **WAICO comparison table:**
    ...
    - Colorado General Assembly, SB 26-189 (revised AI/ADMT law, effective Jan 1, 2027): https://leg.colorado.gov/bills/sb24-205
