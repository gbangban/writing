...
- China's data centers consumed ~200 TWh (terawatt-hours, a unit of total energy — 1 TWh is roughly the annual electricity use of 100,000 US homes) in 2020 (2.7% of national electricity); projected to reach 400 TWh by 2030 (3.7% of national power)
...
- **The "data center vs. power plant" split — Microsoft's Nature paper (2025):**
  - Microsoft researchers published the first public cradle-to-grave life cycle assessment (LCA, an accounting of all environmental impacts across a product's full life from raw materials to disposal) comparing four data center cooling technologies (air-cooled, cold-plate, one-phase immersion, two-phase immersion) across GHG (greenhouse gas — heat-trapping emissions like CO2 that drive climate change) emissions, energy demand, and blue water (fresh surface and groundwater, as opposed to "grey" water already in use) consumption.
...
- **IEA corroboration:**
  ...
  - CO2 emissions from data center electricity peak at ~320 Mt CO2 (megatonnes of CO2 — a million metric tons) by 2030, then enter a shallow decline — because the grid is decarbonizing faster than data center demand is growing.
...
- **US energy mix for data centers (IEA):**
  ...
  - **The near-term result:** Rhodium Group (2025): "Since not much new capacity can be added in the near term, we instead see existing gas and coal plants running at higher capacity factors (the share of a plant's maximum output that it actually produces over a period — 100% means running flat-out around the clock) and meeting 55–85% of increased demand relative to baseline data center demand growth." In the high-emissions scenario, "gas dominates additions through 2035 while renewables struggle to compete."
