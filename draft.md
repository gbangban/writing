...
- **The "data center vs. power plant" split — Microsoft's Nature paper (2025):**
  ...
  - **The critical finding: switching from grid electricity to 100% renewable energy reduces GHG emissions by 85–90%, energy demand by 6–7%, and blue water consumption by 55–85% — regardless of cooling technology.** TODO(verify: 85–90% GHG / 6–7% energy / 55–85% blue-water reduction from switching to 100% renewable — not in the fetched Nature abstract; verify against full paper) This dwarfs the 15–21% GHG savings from switching cooling methods.
  - The paper identifies the "use phase" — the electricity consumed to operate servers — as the largest contributor to environmental impacts for all cooling technologies. TODO(verify: exact "use phase" wording — quote not confirmed in fetched text) "Average grid electricity is still heavily dependent on fossil fuels." Thermal power generation (coal, gas) also requires water to convert to steam.
  ...
  - **Water follows the same logic:** renewable electricity requires far less water for generation than thermal power. Switching to 100% renewable energy reduces blue water consumption by 55–85%, TODO(verify: 55–85% blue-water and 31–52% cooling-tech figures — not in the fetched Nature abstract) compared to 31–52% from switching cooling technologies. The water savings from grid decarbonization are roughly 2x the savings from data center cooling innovation.
...
- **China's renewable buildout (the counterpoint):**
  ...
  - **The comparison in one number:** China installed ~357 GW of renewables in 2024 alone. The US data center sector is projected to need a substantial amount of new capacity by 2030 (EPRI). China's single-year renewable buildout exceeds the entire US data center demand increase over a decade.
