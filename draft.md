...
- The 20th CPC National Congress (2022) report states: "From this day forward, the central task of the Communist Party of China will be to lead the Chinese people of all ethnic groups in a concerted effort to realize the Second Centenary Goal" [7].
- **AI and robotics are explicitly positioned as the engine of this modernization:**
  - Xi (July 2026, WAIC): "Intelligent Manufacturing in China has become another shining hallmark of Chinese modernization." The core smart economy industries are worth at least RMB 1 trillion [2].
  ...
  - 15th Five-Year Plan (March 2026): China will "seize the commanding heights of science and technological development" and seek "decisive breakthroughs in key core technologies," including AI, quantum computing, and humanoid robots [5].
  - Xi (July 2026, WAIC): AI is "moving from the digital world into the physical world" — an endorsement of embedding AI in robotics and intelligent manufacturing as the material basis for modernization [3].
- **The 2050 vision is to create the first Socialist nation in world history:** The May 2024 Xinhua white paper on Chinese modernization states that Chinese modernization "puts people, not capital, first" and "refutes the myth that 'modernization equals Westernization.'" The 20th Congress report frames the path as distinct from "capital-centered modernization, polarized modernization, materialistic expansion, and external plundering." AI and robotics are the material substrate for this alternative modernization path [8].
...
- **IEA corroboration:**
  - Data centers consumed 415 TWh globally in 2024 (1.5% of world electricity); projected to double to ~945 TWh by 2030 (3% of global electricity) [21][26].
  - Renewables are the fastest-growing source of data center electricity, meeting nearly 50% of the growth in data center demand to 2030. In China, renewables + nuclear are expected to push coal into decline for data center operations by 2035 [22].
  - CO2 emissions from data center electricity peak at ~320 Mt CO2 (megatonnes of CO2 — a million metric tons, roughly the annual output of 60–80 typical 1,000 MW coal plants) by 2030, then enter a shallow decline — because the grid is decarbonizing faster than data center demand is growing [23].
  ...
  - **The broader renewable energy buildout is the dominant emissions factor.** Global power sector emissions are plateauing as renewables overtake coal. Renewables and nuclear are expected to account for ~50% of global electricity by 2030 (IEA Electricity 2026). Data center emissions (~300 Mt CO2) are a small fraction of total power sector emissions — and the grid is the thing being decarbonized [24].
...
- Western provinces hold the bulk of new renewable capacity but most computing demand remains in the east
- Companies split operations: western centers for training energy-intensive AI models, eastern centers for customer-facing applications
- New policies may allow off-site renewable generation to ease constraints

### Unknowns: underwater data centers
- Guangdong province five-year marine economy plan (2021): encourage "high energy consuming data centers" to relocate underwater in Guangzhou, Shenzhen, Zhuhai [33][34]
- Follows successful trials by Highlander (specialist firm) in Shenzhen
- Hainan Port pushing ahead with commercial data center using 100+ pressure vessels, powered by nearby nuclear plant
- Follows Microsoft's Project Natick (2-year underwater test off Scotland) [38]
- 2025-2027 Guangdong Action Plan: "explore and plan the construction of underwater data centers in municipalities that possess the necessary conditions" [35][36][37]
 - Underwater cooling eliminates 30-40% of energy spent on cooling

### US vs. China: the energy buildout divergence
- **The core asymmetry:** The US is building AI data centers faster than it can build clean power. China is building clean power faster than it can build data centers. The result is two fundamentally different energy trajectories for the same technology [57].
- **US data center demand:**
  - IEA: US data center electricity demand set to more than double from 2024 to 2030, reaching 426 TWh (~9% of total US electricity demand). US data centers already account for 45% of global data center electricity consumption [21][46].
  - LBNL (2025): US data centers could account for 11.8% of total US electricity by 2030 (range: 9.5–15.3%); 649 TWh in the Reference Case (range: 521–843 TWh) [45].
  ...
  - Reuters (Feb 2026): Cleanview identified 46 US data centers planning to build their own power plants, primarily gas-fired. Their combined 56 GW represents ~30% of all planned US data center capacity [58].
- **US energy mix for data centers (IEA):**
  ...
  - 2030–2035: SMRs (Small Modular Reactors, i.e. small nuclear power plants) enter the mix (tech companies have plans to finance >20 GW of SMRs). By 2035, low-emissions sources account for >55% of US data center electricity [22][59].
...
- **China's renewable buildout (the counterpoint):**
  - 2024: China installed 357 GW (gigawatts — a unit of power capacity; 1 GW can power roughly 1 million homes) of solar and wind in a single year (277 GW solar, 80 GW wind) — a 45% and 18% increase over 2023. AP: "That's akin to building 357 full-size nuclear plants in one year." China surpassed its 1,200 GW renewable target six years early [47][48][55].
  - 2025: China installed a record 430+ GW of solar and wind (315 GW solar, 119 GW wind), a 22% YoY increase. IEA: "nearly 500 GW of additions, accounting for over 60% of global growth." Cumulative wind + solar reached 1.84 TW, accounting for 47.3% of total installed power capacity — surpassing thermal power for the first time [52][53][54][55].
...
- **The carbon emissions divergence:**
  - US: data center growth is met primarily by new and existing gas generation. In the high-emissions scenario, gas dominates through 2035. The US total emissions trajectory for data centers is upward or flat through 2030.
  ...
  - Brookings (Kyle Chan): "The United States largely controls the supply of the most important chips, but China largely controls the supply of renewable energy products, a key means of quickly and sustainably powering them." The "electron gap" could reshape the balance of compute for AI [40].
  - Brookings (David Victor): "For China, there may be opportunities to use AI-related demands for electricity to make fuller use of power that is already oversupplied in some parts of the Chinese grid" [41].
...
- **But "promising on paper" is doing a lot of work.** No thorium reactor has ever been deployed at commercial scale. The US and India both ran experimental thorium programs in the 1960s–1970s; none produced a commercial plant. China is the most advanced country in the current thorium effort: the [TMSR-LF1](https://www.iaea.org/newscenter/news/chinas-2-mw-thorium-based-molten-salt-reactor-achieves-first-criticality) [62] (Thorium Molten Salt Reactor, Lead-Fluoride) is a **2 MWt** (megawatt-thermal) pilot at the Wuwei Institute in Gansu province. It achieved **first criticality in October 2023** and completed its **first thorium-uranium fuel conversion in November 2025** [62][67] — a genuine milestone, but a 2 MWt pilot is a laboratory, not a power plant. The stated target is a **100 MWt demonstration unit by 2035**. Even if that timeline holds, a commercial thorium fleet in China is a 2040s phenomenon, not a 2030s one.
- **The US-vs-China thorium gap is a gap in execution, not in ambition.** The US has no active thorium reactor program at the pilot level. The Thorium Molten Salt Reactor concept (TMSR) is being studied at the university and national-lab level, but there is no funded, operating pilot. China's TMSR-LF1, while small, is the only operating thorium reactor in the world. The strategic implication is the same as in the renewable buildout: China is further along the experimental-to-commercial pipeline, and the lead time matters. A 100 MWt demonstration in 2035 that works gives China a decade of operational data before the US has a comparable pilot.
...
- China's first dedicated regulation for AI companion services took effect July 15, 2026 [68][69][70][72]
- Article 14: absolutely prohibits providing "virtual relatives, virtual lovers, and other virtual intimate relationships" to all minors (under 18) [71]
- Requires risk warnings against excessive reliance; "replacing social interaction" cannot be a service objective [76]
...
- 2025 survey (conducted Jun–Aug 2025, published Mar 2026): >60% of 8,563 minors had used AI; 20.5% said they "want to rely on AI to think, don't want to think for themselves" [73][74][75]

### Ban on replacing workers with AI
- Hangzhou Intermediate People's Court (April 2026): ruled it illegal to terminate employees solely to replace them with AI [77][78]
...
- 2019: National New-Generation AI Governance Principles — 8 principles: harmony & friendliness, fairness & justice, inclusivity & sharing, privacy respect, safety & controllability, shared responsibility, open collaboration, agile governance [87][91][92]
- 2023: Interim Measures for Generative AI Services (effective Aug 15, 2023) — cross-ministerial governance (CAC + 6 ministries); requirements for lawful data, content safety, labeling, risk mitigation, transparency, filing/registration [88][90]
- 2024: AI Safety Governance Framework (Sept 9, 2024) — first version; "people-centered approach"; classifies AI safety risks into inherent and application risks; proposes tiered management based on risk level [89]

### AI in schools from elementary level
- Ministry of Education circular (Dec 2024): enhance AI education in primary and secondary schools; establish related curriculums, incorporate AI into routine teaching, conduct regular evaluations [93]
...
- AI section added to national smart education platform [95]
- 184 pilot schools selected in February 2024 to explore AI education philosophies and models
- East China Normal University + Shanghai AI Lab: "Artificial Intelligence Curriculum Guidelines for Primary and Secondary Schools" — 6-part framework covering course nature, core competency, structure, content, evaluation, implementation [94]
- Beijing: local AI education curriculum guidelines (2025 edition) issued by Municipal Education Commission [96]
...
The US led Pax Silica is a global consortium that seeks to promote US corporate interests around the world with a clear bias towards affluent, global north countries, with an increasingly clear goal of precluding any cooperation with China in the respective countries' AI development [97][98].  
...
It is worth pausing here, because the comparison most people reach for — WAICO versus the EU AI Act versus US AI law — is a comparison of three fundamentally different animals.  WAICO is a state-to-state cooperation club with a charter, a council, and a secretariat, but no fines, no market surveillance, and no power to compel a single company.  The EU AI Act is a binding statute with a risk-based tiering, a dedicated enforcement office, and penalties that reach 7% of a company's global turnover.  And the US has no comparable federal statute at all: a patchwork of state laws, a few executive orders that mostly point the other way, and voluntary frameworks that no one is required to follow [122].  The table below makes that asymmetry explicit, because it is the single clearest way to see what WAICO actually is — and is not.

| | **WAICO** | **EU AI Act** | **US (state/federal)** |
|---|---|---|---|
| **What it is** | Intergovernmental cooperation organization, founded July 16, 2026, headquartered in Shanghai; 29 founding members, now 37, open to all sovereigns, no values test at the door [114] | The world's first comprehensive AI statute — Regulation (EU) 2024/1689, in force since August 1, 2024, applicable in stages through 2028 [115] | No single federal AI law — a patchwork of state statutes, executive orders, and voluntary frameworks [123] |
| **Scope** | All member states; oriented toward AI capacity building, technology sharing, and development cooperation for the Global South | Any AI system placed on the EU market, tiered by risk: prohibited practices, high-risk systems, GPAI models (general-purpose AI — foundation models that can serve a wide range of tasks, like LLMs), and transparency duties | Varies by state and sector — Colorado's ADMT (algorithmic decision-making systems — state law governing automated hiring and employment tools) law [121], California's ADMT and training-data transparency rules, Texas's prohibited-use law, Illinois's employment-AI rules; federal EOs target only government use and frontier-model security |
| **Enforcement** | None. Decisions by consensus or two-thirds majority of the Council; no market surveillance, no regulators, no sanctions | European Commission's AI Office (exclusive over GPAI models) plus national market-surveillance authorities; enforcement powers fully live since August 2, 2026 | State attorneys general enforce state laws (e.g., Colorado AG under the Consumer Protection Act); the FTC enforces sectoral rules; the current administration is actively trying to *strike down* state AI laws rather than enforce them |
| **Key provisions** | Charter, Council, and Secretariat; a stated aim of "beneficial, safe and fair" AI; open-source emphasis; no binding rules on companies [112] | Nine prohibited practices; high-risk conformity assessments; GPAI documentation, copyright, and training-data-summary duties; transparency/labeling; systemic-risk testing | Deregulation: EO 14179 (revokes Biden's EO 14110) [118], EO 14365 (state preemption) [119]; security: EO 14409 (June 2026, frontier-model cyber security — itself forbidding mandatory licensing) [120]; plus state ADMT duties (Colorado, effective Jan 1, 2027) [121] and deepfake/impersonation bans |
| **Legal force** | Soft law — a treaty among states; no direct effect on companies | Binding law — directly applicable across all 27 member states | Mixed: binding state statutes where enacted; executive orders (reversible by a future president); voluntary frameworks with no legal teeth |
| **Penalties** | None | Up to €35M or 7% of global annual turnover (prohibited practices); €15M or 3% (most other breaches); €7.5M or 1% (misleading information) [117] | State-level civil penalties only (e.g., Colorado's consumer-protection remedies); no federal AI fines exist |

Read that table left to right and the point writes itself.  WAICO's entire apparatus is a forum: it can convene, coordinate, and build capacity, but it cannot fine a single developer, withdraw a single model, or compel a single line of code.  The EU, by contrast, has built a real regulator with real money on the line — and as of this writing the AI Office has not yet issued a single fine [116], which is a story about enforcement capacity, not about the absence of power.  The US sits in between and below both: its states have genuine statutes with real enforcement, but its federal government has spent the last two years *deregulating* AI and trying to preempt the states, so there is no Washington counterpart to either Shanghai's club or Brussels's statute.  That is not a flaw in the US model so much as a confession that the US has not decided what it wants AI governance to be.
...
- **Africa-specific investments:**
  ...
  - **China-Africa Community with a Shared Future in Cyberspace (2025–2026 Plan):** China will cultivate African talents in digital economy, e-commerce, ICT, cybersecurity, and AI via the China-Africa Exchange and Cooperation Center. Annual China-Africa Digital Economy Seminar and Cybersecurity Seminar. Dialogue on AI rules, cross-border data flows, and Internet-related laws [108].
...
- **ASEAN-specific investments:**
  - 2026 China-ASEAN Education Cooperation Week (Guizhou, July 28–Aug 2): AI as "a new driver of educational collaboration" [109].
