...
- **China's renewable buildout (the counterpoint):**
  ...
  - **The comparison in one number:** China installed ~357 GW of renewables in 2024 alone — roughly 7x the ~49 GW the entire US added in solar and wind that same year (per ACP/SEIA). A single year of Chinese buildout dwarfs a full year of US additions.
...
- Hangzhou Intermediate People's Court (April 2026): ruled it illegal to terminate employees solely to replace them with AI [77][78][79][80][81]
