...
| **Scope** | All member states; oriented toward AI capacity building, technology sharing, and development cooperation for the Global South | Any AI system placed on the EU market, tiered by risk: prohibited practices, high-risk systems, GPAI models (incl. systemic-risk), and transparency duties | Varies by state and sector — Colorado's ADMT law, California's ADMT and training-data transparency rules, Texas's prohibited-use law, Illinois's employment-AI rules; federal EOs target only government use and frontier-model security |
