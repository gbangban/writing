...
I am intentionally omitting any of the positive AI fluff pieces to keep this focused on contrasting the social models vs trying to defend the technology in its own right.  Moreover, the Chinese model also fundamentally undermines the US AI companies, so their success also means an end to the US AI hegemony, but that is out of scope for this document.   
...
| Nuclear: legacy SMRs in licensing queue, no operating thorium pilot | Nuclear: 64 GW fleet operating today, ACP100 SMR in commissioning, world's only operating thorium pilot |
...
| SMRs in licensing queue; first commercial deployment mid-2030s [60][59] | 64 GW nuclear fleet operating today; ACP100 SMR in commissioning; only operating thorium pilot in the world [61][62] |
...
- **The carbon emissions divergence:**
  ...
  - [Brookings (Kyle Chan)](https://www.brookings.edu/articles/how-will-the-united-states-and-china-power-the-ai-race/) [40]: "The United States largely controls the supply of the most important chips, but China largely controls the supply of renewable energy products, a key means of quickly and sustainably powering them." The "electron gap" could reshape the balance of compute for AI [40].
  - [Brookings (David Victor)](https://www.brookings.edu/articles/interwoven-frontiers-energy-ai-and-us-china-competition/) [41]: "For China, there may be opportunities to use AI-related demands for electricity to make fuller use of power that is already oversupplied in some parts of the Chinese grid" [41].
...
The table below makes the asymmetry between the two explicit, because it is the single clearest way to see what WAICO actually is — and is not — relative to Pax Silica.
