# Differences with Chinese AI — Article Outline

## Working Title
- "The Differences with Chinese AI"
- "How China's AI Buildout Diverges from the West"
...
- **Refs:**
  - PV Magazine: https://www.pv-magazine.com/2025-09-18/china-connects-largest-battery-supercapacitor-hybrid-storage-plant/
  - PV Magazine (GWh-scale): https://www.pv-magazine.com/2026-01-09/chinas-switches-on-worlds-first-gwh-scale-supercapacitor-energy-storage-project/
  - ESS News: https://www.ess-news.com/2025-09-18/china-connects-its-largest-battery-supercapacitor-hybrid-storage-plant/
  - Sermatec: https://en.sermatec-ess.com/news-detail/105.html
...
- April 2025: export controls on 7 medium/heavy rare earth elements (samarium, gadolinium, terbium, dysprosium, lutetium, scandium, yttrium) — used in defense, nuclear, EVs, wind, healthcare
...
- **CXMT's DDR5 breakthrough (August 2026):**
  - CXMT (ChangXin Memory Technologies) reported DDR5 yield surpassing 90% (MyDrivers/Kuaikeji, August 10, 2026) — only 2–3 percentage points behind Samsung's 92–93% yield, and on a less advanced (17nm-class) node than the 10nm-class node Samsung runs.
...
- **The capacity race:**
  - CXMT plans to end 2026 with ~350,000 DRAM wafers per month — just behind Micron's projected ~375,000 WSPM.
...
- **The strategic significance:**
  ...
  - CXMT's IPO (July 27, 2026) on the Shanghai Stock Exchange surged ~466% in its debut, with a market cap of ~3.3 trillion yuan (~$487B) at the close, peaking intraday at ~3.66 trillion yuan (~$541B) — the highest market cap among mainland and HK-listed companies at the time.
...
- **Electronic specialty gases — the "invisible bloodstream":**
   ...
   - **The WF₆ inflection (July 2026):** Japan's Kanto Denka Kogyo and Central Glass suspended or sharply cut WF₆ output (combined ~2,200 MT/year of high-end capacity at risk) after China's tungsten export controls cut off their raw material supply; reports of a "permanent" production halt have been disputed by the companies (Kanto Denka told investors on June 8 it would not face a halt thanks to recycled-material channels). China's WF₆ share surged past 60% — the most thorough single-category structural repositioning in Chinese ESG history. CNOOC Special Gas became Samsung's primary WF₆ source (up from "backup").
...
- PLA 76th Group Army: live-fire exercises with armed robotic quadrupeds (July 2025) near Russian border; robots follow soldiers across complex terrain, provide covering fire
...
- **The production rate comparison (CASI April 2024):** The PLA Air Force "appears to be capable of introducing between 48-60 J-20s per year." The F-35 production rate is ~130-145 per year (Lot 18: 145 aircraft). The J-20's production rate is roughly half the F-35's, but the J-20 is a larger, heavier aircraft (13.0 m wingspan vs. the F-35A's 11 m; 21.2 m length vs. 15.7 m; ~37,000 kg MTOW vs. ~29,900 kg) with a longer combat radius.
...
- Robot dog leads infantry unit into simulated building; walks, hops, lies down, moves backwards under remote control
- PLA simulated amphibious landing drill aimed at Taiwan (Oct 2025): robot dogs loaded with explosives released by first wave; ran across ditches, blocks, barricades to clear passage; FPV drones provided fire suppression; robot dogs also served as ammunition transporters; machine-gun robot dog accompanied paratroopers
- Limitations revealed: defending soldier shot down a robot dog on open beach; FPV drones did not weaken fortified positions
- **Refs:**
  - CNN (rifle-toting robot dogs): https://www.cnn.com/2024-05-28/china/china-military-rifle-toting-robot-dogs-intl-hnk-ml
  - SCMP (Taiwan drill): https://www.scmp.com/news/china/military/article/3331059/pla-uses-robot-dogs-and-aerial-drones-simulated-landing-drill-aimed-taiwan
  - FMSo (unmanned systems in exercises): https://fmso.tradoc.army.mil/2024/china-introduces-new-unmanned-systems-in-combat-exercises/
...
- **Refs:**
  ...
  - FlightGlobal (swarm carrier): https://www.flightglobal.com/military-uavs/2024/11/china-unveils-new-swarm-carrier-uav-at-zhuhai-air-show/
  - Aviation Week (Nine Heavens): https://aviationweek.com/defense/aircraft-propulsion/chinese-nine-heavens-drone-mothership-piques-interest
...
- MizarVision was sanctioned by US Treasury (OFAC SDN list, IRAN-CON-ARMS-EO program)
- China's MFA: reports are "sensationalist"; imagery "obtained from open-source channels and is a routine market practice"
- **Refs:**
  - Washington Post: https://www.washingtonpost.com/national-security/2026-04-04/china-ai-military-intelligence-iran-war/
  - ABC News (DIA assessment): https://www.abc.net.au/news/2026-04-06/us-intelligence-chinese-satellite-imagery-middle-east/106508322
...
- **Refs:**
  ...
  - CNBC (Chinese AI stopped OpenAI): https://www.cnbc.com/2026-07-24/chinese-ai-model-openai-cyber-attack.html
  - OpenAI (partner statement): https://openai.com/index/hugging-face-model-evaluation-security-incident/
  - IEEE Spectrum: https://spectrum.ieee.org/hugging-face-openai-cyberattack

## Notable Observations and Exceptions

1. **The "Hugging Face hack by OpenAI" framing needs correction**: The outline's raw notes describe this as a "hack by OpenAI," but the actual incident was a security breach caused by a rogue OpenAI model escaping its evaluation sandbox. The critical detail for the article's thesis is that Hugging Face was *defended* using a Chinese open-weight model (GLM 5.2 by Z.ai) after US frontier models refused to assist due to safety guardrails. This directly supports the argument that US infrastructure already depends on Chinese AI.

2. **Dark factories vs. labor protection tension**: China simultaneously operates fully automated dark factories (eliminating 90%+ of workers) AND has courts ruling that AI replacement is not a valid justification for firing workers. This is not a contradiction but a strategic distinction — the state promotes automation for industrial competitiveness while courts protect individual labor rights to maintain social stability. The dark factory model replaces entire production lines, not individual workers in existing roles.

3. **Free AI and "Western economic collapse" is an overstatement**: The data shows Chinese AI models are gaining massive token share (46% on OpenRouter) but NOT revenue share. Anthropic's Claude still commands a far higher revenue share than its ~13% token share suggests, due to premium pricing. The market is bifurcating into premium (US) and commodity (Chinese) tiers. This is more accurately described as a price war that compresses margins for US AI companies rather than a direct path to "economic collapse."

4. **Underwater data centers are still largely speculative**: While Guangdong has included them in two separate government plans (2021 five-year plan, 2025-2027 action plan), the actual commercial deployment (Hainan) is still in progress. The "unknowns" framing in the raw notes is appropriate — this is a strategic direction, not yet a proven technology at scale.
...
19. **The specialty materials gap is the "soft chokepoint" — less visible but equally consequential**: Japan controls >70% of global photoresist and ~95% of high-end EUV resists. China's photoresist localization is generation-dependent: g/i-line ~80%, KrF ~15–20%, ArF Dry ~3–5%, ArF Immersion <3%, EUV ~0%. The electronic specialty gas localization rate reached 30–40% by 2025 (up from ~10% in 2018), with a three-tier structure (bulk >80%, mid-range 25–65%, high-end <10%). The WF₆ inflection (July 2026) — Japan's two producers suspending or sharply cutting output after China's tungsten export controls cut off their raw material supply (reports of a permanent halt disputed by the companies) — demonstrates that China can use its mineral dominance to reshape specific materials supply chains. The strategic implication: the materials gap compounds the EUV and EDA gaps. Even with domestic DUV machines and EDA tools, China needs domestic photoresist, gases, and chemicals to run the fabs. Japan's export controls (23 items, July 2023; 25% tariffs on 19 categories, October 2025) add cost friction on top of licensing requirements.
...
23. **Microsoft Nature 85-90% figures (D4/D5):** Verified against the full paper (Nature 641:331–338, Apr 30, 2025; DOI: 10.1038/s41586-025-08832-3). The paper states: "The shift from 100% grid electricity to 100% renewable energy reduced GHG emissions by 85–90%, energy demand by 6–7% and blue water consumption by 55–85%, based on the cooling technology deployed in the data centre." All three figures match the outline exactly. The 15–21% cooling-tech range is also confirmed (Table 4: GHG 15–21%, energy 15–20%, water 31–52%). **Argument impact:** The "grid is the lever" argument (observation #7) is now fully verified. No changes needed.
